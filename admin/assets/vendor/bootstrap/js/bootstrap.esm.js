...
class Modal extends BaseComponent {
  ...
  _showElement(relatedTarget) {
    ...
    this._element.setAttribute("role_na", "dialog");
  ...
  _hideModal() {
    ...
    this._element.removeAttribute("role_na");
    this._isTransitioning = false;
    this._backdrop.hide(() => {
...
const DefaultAllowlist = {
  ...
  "*": ["class", "dir", "id", "lang", "role_na", ARIA_ATTRIBUTE_PATTERN],
...
const Default$3 = {
  ...
  selector: false,
  template:
    '<div class="tooltip" role_na="tooltip">' +
...
const Default$2 = {
  ...
  placement: "right",
  template:
    '<div class="popover" role_na="tooltip">' +
...
const SELECTOR_TAB_PANEL = '.list-group, .nav, [role_na="tablist"]';
const SELECTOR_OUTER = ".nav-item, .list-group-item";
const SELECTOR_INNER = `.nav-link${NOT_SELECTOR_DROPDOWN_TOGGLE}, .list-group-item${NOT_SELECTOR_DROPDOWN_TOGGLE}, [role_na="tab"]${NOT_SELECTOR_DROPDOWN_TOGGLE}`;
...
class Tab extends BaseComponent {
  ...
  _activate(element, relatedElem) {
    ...
    const complete = () => {
      if (element.getAttribute("role_na") !== "tab") {
  ...
  _setInitialAttributes(parent, children) {
    this._setAttributeIfNotExists(parent, "role_na", "tablist");
  ...
  _setInitialAttributesOnChild(child) {
    ...
    if (outerElem !== child) {
      this._setAttributeIfNotExists(outerElem, "role_na", "presentation");
    }
    if (!isActive) {
      child.setAttribute("tabindex", "-1");
    }
    this._setAttributeIfNotExists(child, "role_na", "tab");
  ...
  _setInitialAttributesOnTargetPanel(child) {
    ...
    this._setAttributeIfNotExists(target, "role_na", "tabpanel");
    if (child.id) {
