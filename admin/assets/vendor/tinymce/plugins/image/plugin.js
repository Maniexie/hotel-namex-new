...
(function () {
  ...
  const getIsDecorative = (image) =>
    ...
    DOM.getAttrib(image, "role_na") === "presentation";
  const getAlt = (image) => {
  ...
  const setAlt = (image, alt, isDecorative) => {
    if (isDecorative) {
      DOM.setAttrib(image, "role_na", "presentation");
      ...
      if (DOM.getAttrib(image, "role_na") === "presentation") {
        DOM.setAttrib(image, "role_na", "");
      }
    }
  };
